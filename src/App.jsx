...
function EditModal({item,categories,household,debts=[],bills=[],accounts={},settings={},onSave,onDelete,onClose}){
  const[form,setForm]=useState(()=>{
    ...
    return{
      ...
      billBankAccountId:lb?.bankAccountId!=null&&String(lb.bankAccountId)!==""?String(lb.bankAccountId):String(pickDefaultBankAccountId(lb?normalizePaidFrom(lb.paidFrom):defPf,accounts,settings)||""),
    };
  });
