...
import { Plus, Search, X, Filter, Tag, Wallet, Trash2, Check, CheckCircle2, Circle, Scale, Target } from "lucide-react";
...
import { normalizePaidFrom, sumMtdByPaidFrom, canReverseExpenseBalance, resolveBankAccountIdForExpense, resolveBillSpendIds, validateCashSpendPrerequisites, PAID_FROM_OPTIONS, PAID_FROM_FS_LABELS } from "../lib/accountsLogic.js";
import { cardDebtsList } from "../lib/creditCardTotals.js";
import { cashAccountsByKind } from "../lib/cashAccounts.js";
import { commitMarkBillPaid, commitMarkBillsPaidList, billHasLoanUndoSnap, billsDueTotalInMonth, billsMarkedPaidTotalInMonth } from "../lib/billsLogic.js";
import { rewindRecurringDueDate } from "../lib/billsLogic.js";
...
export default function SpendingView({expenses,setExpenses,budgetGoals,setBGoals,categories,setEditItem,onAdd,showToast,showUndoToast,household,applySpend,applyRefund,accounts={},debts=[],settings={}}){
  ...
  <div className="fu">
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div><div className="fv-page-title">Bills</div><div className="fv-page-sub">{unpaid.length} unpaid · {overdue.length} overdue</div></div>
